...
class SetPointPublisher(Node):
    def __init__(self):
        ...
        self.signal_publisher = self.create_publisher(Float32, 'RCGset_point', 10)    ## CHECK FOR THE NAME OF THE TOPIC
    ...
    def timer_cb(self):
        ...
        if (self.signal_type == 'sine'):
            ...
            # Alternative for generating square singal (using sin, no duty cycle)
